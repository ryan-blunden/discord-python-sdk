...
res = s.guild_members.search(guild_id="<value>", limit=886866, query="<value>")
...
**[List[models.GuildMemberResponse]](../../models/.md)**
...
res = s.guild_members.update_self(guild_id="<value>", request_body={})
...
res = s.guild_members.add(guild_id="<value>", user_id="<value>", request_body={
    "access_token": "<value>",
})
...
s.guild_members.delete(guild_id="<value>", user_id="<value>")
...
res = s.guild_members.list(guild_id="<value>")
