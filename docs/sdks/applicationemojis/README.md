...
res = s.application_emojis.get(application_id="<value>", emoji_id="<value>")
...
res = s.application_emojis.list(application_id="<value>")
...
**[models.ListApplicationEmojisResponse](../../models/listapplicationemojisresponse.md)**
...
res = s.application_emojis.create(application_id="<value>", request_body={
    "name": "<value>",
