...
class Soundboards(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> models.ListGuildSoundboardSoundsResponse:
        r"""
        :param guild_id:
        ...
        request = models.ListGuildSoundboardSoundsRequest(
            guild_id=guild_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_guild_soundboard_sounds",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.ListGuildSoundboardSoundsResponse
            )
