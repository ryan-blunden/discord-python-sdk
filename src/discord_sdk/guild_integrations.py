...
class GuildIntegrations(BaseSDK):
    def delete(
        self,
        *,
        guild_id: str,
        ...
        request = models.DeleteGuildIntegrationRequest(
            guild_id=guild_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_guild_integration",
                oauth2_scopes=[],
    ...
    def list(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> List[models.ListGuildIntegrationsResponseBody]:
        r"""
        :param guild_id:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        ...
        request = models.ListGuildIntegrationsRequest(
            guild_id=guild_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_guild_integrations",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.ListGuildIntegrationsResponseBody]
            )
        if utils.match_response(http_res, "4XX", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ErrorResponseData)
            raise models.ErrorResponse(data=data)
