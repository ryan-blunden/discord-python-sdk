...
class GuildChannels(BaseSDK):
    def list(
        self,
        *,
        security: Union[
            models.ListGuildChannelsSecurity, models.ListGuildChannelsSecurityTypedDict
        ],
        guild_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> List[models.ListGuildChannelsResponseBody]:
        r"""
        :param security:
        :param guild_id:
        ...
        request = models.ListGuildChannelsRequest(
            guild_id=guild_id,
        )
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ListGuildChannelsSecurity
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_guild_channels",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.ListGuildChannelsResponseBody]
            )
