...
class Stickers(BaseSDK):
    def get(
        ...
        *,
        ...
        request = models.GetGuildStickerRequest(
            guild_id=guild_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get_guild_sticker",
                oauth2_scopes=[],
    ...
    def delete(
        ...
        *,
        ...
        request = models.DeleteGuildStickerRequest(
            guild_id=guild_id,
            sticker_id=sticker_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_guild_sticker",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    def fetch_by_id(
        ...
        *,
        ...
        request = models.GetStickerRequest(
            sticker_id=sticker_id,
        )
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GetStickerResponseBody)
        if utils.match_response(http_res, "4XX", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ErrorResponseData)
            raise models.ErrorResponse(data=data)
        if utils.match_response(http_res, "5XX", "*"):
