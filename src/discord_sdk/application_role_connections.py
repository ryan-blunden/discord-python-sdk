...
class ApplicationRoleConnections(BaseSDK):
    def update(
        self,
        *,
        application_id: str,
        request_body: Union[
            models.UpdateApplicationUserRoleConnectionRequestBody,
            models.UpdateApplicationUserRoleConnectionRequestBodyTypedDict,
        ],
        ...
        request = models.UpdateApplicationUserRoleConnectionRequest(
            application_id=application_id,
            request_body=utils.get_pydantic_model(
                request_body, models.UpdateApplicationUserRoleConnectionRequestBody
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="update_application_user_role_connection",
    ...
    def get_metadata(
        ...
        *,
        ...
        request = models.GetApplicationRoleConnectionsMetadataRequest(
            application_id=application_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get_application_role_connections_metadata",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
