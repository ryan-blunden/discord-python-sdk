...
class Widgets(BaseSDK):
    def update_settings(
        self,
        *,
        guild_id: str,
        request_body: Union[
            models.UpdateGuildWidgetSettingsRequestBody,
            models.UpdateGuildWidgetSettingsRequestBodyTypedDict,
        ],
        ...
        request = models.UpdateGuildWidgetSettingsRequest(
            guild_id=guild_id,
            request_body=utils.get_pydantic_model(
                request_body, models.UpdateGuildWidgetSettingsRequestBody
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="update_guild_widget_settings",
                oauth2_scopes=[],
