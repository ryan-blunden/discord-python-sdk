...
class DiscordWebhooks(BaseSDK):
    def list(
        ...
        *,
    ...
    ) -> List[models.ListChannelWebhooksResponseBody]:
        r"""
        :param channel_id:
        ...
        request = models.ListChannelWebhooksRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_channel_webhooks",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.ListChannelWebhooksResponseBody]
            )
