...
class GuildEmojis(BaseSDK):
    def delete(
        ...
        *,
        ...
        request = models.DeleteGuildEmojiRequest(
            guild_id=guild_id,
            emoji_id=emoji_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_guild_emoji",
                oauth2_scopes=[],
    ...
    def create(
        ...
        *,
        guild_id: str,
        request_body: Union[
            models.CreateGuildEmojiRequestBody,
            models.CreateGuildEmojiRequestBodyTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = models.CreateGuildEmojiRequest(
            guild_id=guild_id,
            request_body=utils.get_pydantic_model(
                request_body, models.CreateGuildEmojiRequestBody
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="create_guild_emoji",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
