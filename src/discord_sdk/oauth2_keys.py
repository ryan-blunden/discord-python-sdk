...
class Oauth2Keys(BaseSDK):
    def get(
        self,
        *,
        security: Optional[
            Union[models.GetPublicKeysSecurity, models.GetPublicKeysSecurityTypedDict]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.OAuth2GetKeys:
        r"""
        :param security:
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.GetPublicKeysSecurity]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.OAuth2GetKeys)
