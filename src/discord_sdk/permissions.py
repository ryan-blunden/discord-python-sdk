...
class Permissions(BaseSDK):
    def set_overwrite(
        ...
        *,
        ...
        overwrite_id: str,
        request_body: Union[
            models.SetChannelPermissionOverwriteRequestBody,
            models.SetChannelPermissionOverwriteRequestBodyTypedDict,
        ],
        ...
        request = models.SetChannelPermissionOverwriteRequest(
            channel_id=channel_id,
            overwrite_id=overwrite_id,
            request_body=utils.get_pydantic_model(
                request_body, models.SetChannelPermissionOverwriteRequestBody
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="set_channel_permission_overwrite",
                oauth2_scopes=[],
