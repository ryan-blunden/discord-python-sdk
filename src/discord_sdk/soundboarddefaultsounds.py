...
class SoundboardDefaultSounds(BaseSDK):
    def list(
        self,
        *,
    ...
    ) -> List[models.SoundboardSoundResponse]:
        r"""
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get_soundboard_default_sounds",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.SoundboardSoundResponse]
            )
