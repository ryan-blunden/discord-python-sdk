...
class DiscordThreads(BaseSDK):
    def list_private_archived(
        self,
        *,
        channel_id: str,
        ...
        request = models.ListPrivateArchivedThreadsRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_private_archived_threads",
                oauth2_scopes=[],
    ...
    async def list_private_archived_async(
        self,
        *,
        channel_id: str,
        before: Optional[datetime] = None,
