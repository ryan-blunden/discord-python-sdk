...
class Templates(BaseSDK):
    def get(
        ...
        *,
        ...
        security: Optional[
            Union[
                models.GetGuildTemplateSecurity,
                models.GetGuildTemplateSecurityTypedDict,
            ]
        ] = None,
        ...
        request = models.GetGuildTemplateRequest(
            code=code,
        )
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.GetGuildTemplateSecurity]
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get_guild_template",
                oauth2_scopes=[],
