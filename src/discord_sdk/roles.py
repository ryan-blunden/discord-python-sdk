...
class Roles(BaseSDK):
    def delete_member_role(
        ...
        *,
        ...
        request = models.DeleteGuildMemberRoleRequest(
            guild_id=guild_id,
            user_id=user_id,
            role_id=role_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_guild_member_role",
                oauth2_scopes=[],
    ...
    async def delete_member_role_async(
        self,
        *,
        guild_id: str,
        user_id: str,
    ...
    def get(
        ...
        *,
        ...
        request = models.GetGuildRoleRequest(
            guild_id=guild_id,
            role_id=role_id,
        )
    ...
    def list(
        ...
        *,
        ...
        request = models.ListGuildRolesRequest(
            guild_id=guild_id,
        )
