...
class GuildWebhooks(BaseSDK):
    def get(
        ...
        *,
    ...
    ) -> List[models.GetGuildWebhooksResponseBody]:
        r"""
        :param guild_id:
        ...
        request = models.GetGuildWebhooksRequest(
            guild_id=guild_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get_guild_webhooks",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.GetGuildWebhooksResponseBody]
            )
