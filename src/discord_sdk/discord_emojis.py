...
class DiscordEmojis(BaseSDK):
    def update(
        ...
        *,
        ...
        emoji_id: str,
        request_body: Union[
            models.UpdateApplicationEmojiRequestBody,
            models.UpdateApplicationEmojiRequestBodyTypedDict,
        ],
        ...
        request = models.UpdateApplicationEmojiRequest(
            application_id=application_id,
            emoji_id=emoji_id,
            request_body=utils.get_pydantic_model(
                request_body, models.UpdateApplicationEmojiRequestBody
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="update_application_emoji",
                oauth2_scopes=[],
