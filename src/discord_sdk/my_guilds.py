...
class MyGuilds(BaseSDK):
    def list(
        self,
        *,
        security: Union[
            models.ListMyGuildsSecurity, models.ListMyGuildsSecurityTypedDict
        ],
        ...
        request = models.ListMyGuildsRequest(
            before=before,
            after=after,
            limit=limit,
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(security, models.ListMyGuildsSecurity),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_my_guilds",
                oauth2_scopes=["guilds"],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.MyGuildResponse])
