...
class UpdateGuildChannelRequestPartialType(int, Enum):
    ZERO = 0
    TWO = 2
    FOUR = 4
    FIVE = 5
...
class UpdateGuildChannelRequestPartialTypedDict(TypedDict):
    type: NotRequired[Nullable[UpdateGuildChannelRequestPartialType]]
    ...
    available_tags: NotRequired[Nullable[List[UpdateThreadTagRequestTypedDict]]]


class UpdateGuildChannelRequestPartial(BaseModel):
    type: OptionalNullable[UpdateGuildChannelRequestPartialType] = UNSET
    ...
    available_tags: OptionalNullable[List[UpdateThreadTagRequest]] = UNSET
