...
ApplicationCommandPatchRequestPartialOptionsTypedDict = Union[
    ApplicationCommandAttachmentOptionTypedDict,
    ApplicationCommandBooleanOptionTypedDict,
    ApplicationCommandMentionableOptionTypedDict,
    ApplicationCommandRoleOptionTypedDict,
...
ApplicationCommandPatchRequestPartialOptions = Union[
    ApplicationCommandAttachmentOption,
    ApplicationCommandBooleanOption,
    ApplicationCommandMentionableOption,
    ApplicationCommandRoleOption,
...
class ApplicationCommandPatchRequestPartialTypedDict(TypedDict):
    ...
    options: NotRequired[
        Nullable[List[ApplicationCommandPatchRequestPartialOptionsTypedDict]]
    ]
...
class ApplicationCommandPatchRequestPartial(BaseModel):
    ...
    options: OptionalNullable[List[ApplicationCommandPatchRequestPartialOptions]] = (
        UNSET
    )
