...
class ApplicationCommandStringOptionTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    choices: NotRequired[Nullable[List[ApplicationCommandOptionStringChoiceTypedDict]]]
...
class ApplicationCommandStringOption(BaseModel):
    ...
    choices: OptionalNullable[List[ApplicationCommandOptionStringChoice]] = UNSET
