...
class ApplicationCommandSubcommandGroupOptionTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    options: NotRequired[Nullable[List[ApplicationCommandSubcommandOptionTypedDict]]]
...
class ApplicationCommandSubcommandGroupOption(BaseModel):
    ...
    options: OptionalNullable[List[ApplicationCommandSubcommandOption]] = UNSET
