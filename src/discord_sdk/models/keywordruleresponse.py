...
KeywordRuleResponseActionsTypedDict = Union[
    BlockMessageActionResponseTypedDict,
    FlagToChannelActionResponseTypedDict,
    QuarantineUserActionResponseTypedDict,
    UserCommunicationDisabledActionResponseTypedDict,
...
KeywordRuleResponseActions = Union[
    BlockMessageActionResponse,
    FlagToChannelActionResponse,
    QuarantineUserActionResponse,
    UserCommunicationDisabledActionResponse,
...
class KeywordRuleResponseTypedDict(TypedDict):
    id: str
    guild_id: str
    creator_id: str
    name: str
    actions: List[KeywordRuleResponseActionsTypedDict]
    trigger_metadata: KeywordTriggerMetadataResponseTypedDict
...
class KeywordRuleResponse(BaseModel):
    ...
    actions: List[KeywordRuleResponseActions]
