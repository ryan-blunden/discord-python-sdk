...
class UpdateWebhookMessageMultipartSecurityTypedDict(TypedDict):
    bot_token: NotRequired[str]


class UpdateWebhookMessageMultipartSecurity(BaseModel):
    bot_token: Annotated[
        Optional[str],
        FieldMetadata(
...
class UpdateWebhookMessageMultipartRequestBodyTypedDict(TypedDict):
...
class UpdateWebhookMessageMultipartRequestBody(BaseModel):
...
class UpdateWebhookMessageMultipartRequestTypedDict(TypedDict):
    webhook_id: str
    webhook_token: str
    message_id: str
    request_body: UpdateWebhookMessageMultipartRequestBodyTypedDict
    thread_id: NotRequired[str]


class UpdateWebhookMessageMultipartRequest(BaseModel):
