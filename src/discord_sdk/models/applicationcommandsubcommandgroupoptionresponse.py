...
class ApplicationCommandSubcommandGroupOptionResponseTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    options: NotRequired[
        Nullable[List[ApplicationCommandSubcommandOptionResponseTypedDict]]
    ]
...
class ApplicationCommandSubcommandGroupOptionResponse(BaseModel):
    ...
    options: OptionalNullable[List[ApplicationCommandSubcommandOptionResponse]] = UNSET
