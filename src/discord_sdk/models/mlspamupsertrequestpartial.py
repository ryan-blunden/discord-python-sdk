...
MLSpamUpsertRequestPartialActionsTypedDict = Union[
...
MLSpamUpsertRequestPartialActions = Union[
    BlockMessageAction,
    FlagToChannelAction,
...
class MLSpamUpsertRequestPartialTypedDict(TypedDict):
    name: NotRequired[str]
    event_type: Literal[1]
    actions: NotRequired[Nullable[List[MLSpamUpsertRequestPartialActionsTypedDict]]]
    ...
    trigger_metadata: NotRequired[Nullable[MLSpamTriggerMetadataTypedDict]]
...
class MLSpamUpsertRequestPartial(BaseModel):
    ...
    actions: OptionalNullable[List[MLSpamUpsertRequestPartialActions]] = UNSET
    ...
    trigger_metadata: OptionalNullable[MLSpamTriggerMetadata] = UNSET
