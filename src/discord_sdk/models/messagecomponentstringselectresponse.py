...
class MessageComponentStringSelectResponseTypedDict(TypedDict):
    id: int
    custom_id: str
    type: Literal[1]
    ...
    options: NotRequired[Nullable[List[SelectOptionResponseTypedDict]]]


class MessageComponentStringSelectResponse(BaseModel):
    id: int
    ...
    options: OptionalNullable[List[SelectOptionResponse]] = UNSET
