...
class MessageComponentRoleSelectResponseTypedDict(TypedDict):
    id: int
    custom_id: str
    type: Literal[1]
    ...
    default_values: NotRequired[Nullable[List[RoleSelectDefaultValueResponseTypedDict]]]


class MessageComponentRoleSelectResponse(BaseModel):
    id: int
    ...
    default_values: OptionalNullable[List[RoleSelectDefaultValueResponse]] = UNSET
