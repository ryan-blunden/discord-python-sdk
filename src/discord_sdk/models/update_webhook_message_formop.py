...
class UpdateWebhookMessageFormSecurityTypedDict(TypedDict):
    bot_token: NotRequired[str]


class UpdateWebhookMessageFormSecurity(BaseModel):
    bot_token: Annotated[
        Optional[str],
        FieldMetadata(
...
class UpdateWebhookMessageFormRequestTypedDict(TypedDict):
    webhook_id: str
    webhook_token: str
    message_id: str
...
class UpdateWebhookMessageFormRequest(BaseModel):
