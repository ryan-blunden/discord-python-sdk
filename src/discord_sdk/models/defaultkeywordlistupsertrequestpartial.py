...
DefaultKeywordListUpsertRequestPartialActionsTypedDict = Union[
...
DefaultKeywordListUpsertRequestPartialActions = Union[
    BlockMessageAction,
    FlagToChannelAction,
...
class DefaultKeywordListUpsertRequestPartialTypedDict(TypedDict):
    name: NotRequired[str]
    event_type: Literal[1]
    actions: NotRequired[
        Nullable[List[DefaultKeywordListUpsertRequestPartialActionsTypedDict]]
    ]
    ...
    trigger_metadata: NotRequired[DefaultKeywordListTriggerMetadataTypedDict]
...
class DefaultKeywordListUpsertRequestPartial(BaseModel):
    ...
    actions: OptionalNullable[List[DefaultKeywordListUpsertRequestPartialActions]] = (
        UNSET
    )
