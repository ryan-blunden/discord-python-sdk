...
class StageScheduledEventPatchRequestPartialTypedDict(TypedDict):
    ...
    entity_metadata: NotRequired[Nullable[EntityMetadataStageInstanceTypedDict]]
...
class StageScheduledEventPatchRequestPartial(BaseModel):
    ...
    entity_metadata: OptionalNullable[EntityMetadataStageInstance] = UNSET
