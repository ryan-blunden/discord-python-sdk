...
class AddGuildMemberRequestBodyTypedDict(TypedDict):
    access_token: str
...
class AddGuildMemberRequestBody(BaseModel):
    access_token: str
    ...
    def serialize_model(self, handler):
        optional_fields = ["nick", "roles", "mute", "deaf", "flags"]
        nullable_fields = ["nick", "roles", "mute", "deaf", "flags"]
        null_default_fields = []
...
class AddGuildMemberRequestTypedDict(TypedDict):
    guild_id: str
    user_id: str
    request_body: AddGuildMemberRequestBodyTypedDict
