...
ApplicationCommandSubcommandOptionOptionsTypedDict = Union[
    ApplicationCommandAttachmentOptionTypedDict,
    ApplicationCommandBooleanOptionTypedDict,
    ApplicationCommandMentionableOptionTypedDict,
    ApplicationCommandRoleOptionTypedDict,
...
ApplicationCommandSubcommandOptionOptions = Union[
    ApplicationCommandAttachmentOption,
    ApplicationCommandBooleanOption,
    ApplicationCommandMentionableOption,
    ApplicationCommandRoleOption,
...
class ApplicationCommandSubcommandOptionTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    options: NotRequired[
        Nullable[List[ApplicationCommandSubcommandOptionOptionsTypedDict]]
    ]
...
class ApplicationCommandSubcommandOption(BaseModel):
    ...
    options: OptionalNullable[List[ApplicationCommandSubcommandOptionOptions]] = UNSET
