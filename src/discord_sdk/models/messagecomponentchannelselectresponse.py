...
class MessageComponentChannelSelectResponseTypedDict(TypedDict):
    id: int
    custom_id: str
    type: Literal[1]
    ...
    default_values: NotRequired[
        Nullable[List[ChannelSelectDefaultValueResponseTypedDict]]
    ]


class MessageComponentChannelSelectResponse(BaseModel):
    id: int
    ...
    default_values: OptionalNullable[List[ChannelSelectDefaultValueResponse]] = UNSET
