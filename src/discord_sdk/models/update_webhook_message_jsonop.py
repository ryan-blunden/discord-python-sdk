...
class UpdateWebhookMessageJSONSecurityTypedDict(TypedDict):
    bot_token: NotRequired[str]


class UpdateWebhookMessageJSONSecurity(BaseModel):
    bot_token: Annotated[
        Optional[str],
        FieldMetadata(
...
class UpdateWebhookMessageJSONRequestTypedDict(TypedDict):
    webhook_id: str
    webhook_token: str
    message_id: str
...
class UpdateWebhookMessageJSONRequest(BaseModel):
