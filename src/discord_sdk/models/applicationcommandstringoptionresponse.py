...
class ApplicationCommandStringOptionResponseTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    choices: NotRequired[
        Nullable[List[ApplicationCommandOptionStringChoiceResponseTypedDict]]
    ]
...
class ApplicationCommandStringOptionResponse(BaseModel):
    ...
    choices: OptionalNullable[List[ApplicationCommandOptionStringChoiceResponse]] = (
        UNSET
    )
