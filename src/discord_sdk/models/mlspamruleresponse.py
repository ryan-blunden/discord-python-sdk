...
MLSpamRuleResponseActionsTypedDict = Union[
    BlockMessageActionResponseTypedDict,
    FlagToChannelActionResponseTypedDict,
    QuarantineUserActionResponseTypedDict,
    UserCommunicationDisabledActionResponseTypedDict,
...
MLSpamRuleResponseActions = Union[
    BlockMessageActionResponse,
    FlagToChannelActionResponse,
    QuarantineUserActionResponse,
    UserCommunicationDisabledActionResponse,
...
class MLSpamRuleResponseTypedDict(TypedDict):
    id: str
    guild_id: str
    creator_id: str
    name: str
    actions: List[MLSpamRuleResponseActionsTypedDict]
    trigger_metadata: MLSpamTriggerMetadataResponseTypedDict
...
class MLSpamRuleResponse(BaseModel):
    ...
    actions: List[MLSpamRuleResponseActions]
