...
class MessageComponentUserSelectResponseTypedDict(TypedDict):
    id: int
    custom_id: str
    type: Literal[1]
    ...
    default_values: NotRequired[Nullable[List[UserSelectDefaultValueResponseTypedDict]]]


class MessageComponentUserSelectResponse(BaseModel):
    id: int
    ...
    default_values: OptionalNullable[List[UserSelectDefaultValueResponse]] = UNSET
