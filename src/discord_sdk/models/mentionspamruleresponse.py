...
MentionSpamRuleResponseActionsTypedDict = Union[
    BlockMessageActionResponseTypedDict,
    FlagToChannelActionResponseTypedDict,
    QuarantineUserActionResponseTypedDict,
    UserCommunicationDisabledActionResponseTypedDict,
...
MentionSpamRuleResponseActions = Union[
    BlockMessageActionResponse,
    FlagToChannelActionResponse,
    QuarantineUserActionResponse,
    UserCommunicationDisabledActionResponse,
...
class MentionSpamRuleResponseTypedDict(TypedDict):
    id: str
    guild_id: str
    creator_id: str
    name: str
    actions: List[MentionSpamRuleResponseActionsTypedDict]
    trigger_metadata: MentionSpamTriggerMetadataResponseTypedDict
...
class MentionSpamRuleResponse(BaseModel):
    ...
    actions: List[MentionSpamRuleResponseActions]
