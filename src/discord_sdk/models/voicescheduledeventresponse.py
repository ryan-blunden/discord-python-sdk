...
class VoiceScheduledEventResponseTypedDict(TypedDict):
    id: str
    guild_id: str
    name: str
    ...
    entity_metadata: NotRequired[Nullable[EntityMetadataVoiceResponseTypedDict]]
...
class VoiceScheduledEventResponse(BaseModel):
    ...
    entity_metadata: OptionalNullable[EntityMetadataVoiceResponse] = UNSET
