...
class PrivateApplicationResponseTypedDict(TypedDict):
    id: str
    name: str
    description: str
    verify_key: str
    ...
    approximate_guild_count: NotRequired[Nullable[int]]
    explicit_content_filter: Literal[0]
    team: NotRequired[Nullable[TeamResponseTypedDict]]
...
class PrivateApplicationResponse(BaseModel):
    ...
    approximate_guild_count: OptionalNullable[int] = UNSET
    ...
    team: OptionalNullable[TeamResponse] = UNSET
