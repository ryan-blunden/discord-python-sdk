...
class ApplicationRoleConnectionsMetadataItemResponseTypedDict(TypedDict):
    key: str
    name: str
    description: str
    type: Literal[1]
...
class ApplicationRoleConnectionsMetadataItemResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["name_localizations", "description_localizations"]
        nullable_fields = ["name_localizations", "description_localizations"]
        null_default_fields = []
