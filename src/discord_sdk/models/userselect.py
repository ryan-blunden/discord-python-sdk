...
class UserSelectTypedDict(TypedDict):
    custom_id: str
    type: Literal[1]
    ...
    default_values: NotRequired[Nullable[List[UserSelectDefaultValueTypedDict]]]
...
class UserSelect(BaseModel):
    ...
    default_values: OptionalNullable[List[UserSelectDefaultValue]] = UNSET
