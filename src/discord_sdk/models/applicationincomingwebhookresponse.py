...
class ApplicationIncomingWebhookResponseTypedDict(TypedDict):
    id: str
    name: str
...
class ApplicationIncomingWebhookResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["application_id", "avatar", "channel_id", "guild_id", "user"]
        nullable_fields = ["application_id", "avatar", "channel_id", "guild_id", "user"]
        null_default_fields = []
