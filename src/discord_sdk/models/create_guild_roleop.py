...
class CreateGuildRoleRequestBodyTypedDict(TypedDict):
...
class CreateGuildRoleRequestBody(BaseModel):
...
class CreateGuildRoleRequestTypedDict(TypedDict):
    guild_id: str
    request_body: CreateGuildRoleRequestBodyTypedDict
