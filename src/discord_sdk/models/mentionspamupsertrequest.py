...
MentionSpamUpsertRequestActionsTypedDict = Union[
...
MentionSpamUpsertRequestActions = Union[
    BlockMessageAction,
    FlagToChannelAction,
...
class MentionSpamUpsertRequestTypedDict(TypedDict):
    name: str
    event_type: Literal[1]
    actions: NotRequired[Nullable[List[MentionSpamUpsertRequestActionsTypedDict]]]
...
class MentionSpamUpsertRequest(BaseModel):
    ...
    actions: OptionalNullable[List[MentionSpamUpsertRequestActions]] = UNSET
