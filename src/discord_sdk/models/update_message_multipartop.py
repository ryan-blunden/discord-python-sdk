...
class UpdateMessageMultipartRequestBodyTypedDict(TypedDict):
...
class UpdateMessageMultipartRequestBody(BaseModel):
...
class UpdateMessageMultipartRequestTypedDict(TypedDict):
    channel_id: str
    message_id: str
    request_body: UpdateMessageMultipartRequestBodyTypedDict


class UpdateMessageMultipartRequest(BaseModel):
