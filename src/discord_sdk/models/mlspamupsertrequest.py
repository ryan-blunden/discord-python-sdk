...
MLSpamUpsertRequestActionsTypedDict = Union[
...
MLSpamUpsertRequestActions = Union[
    BlockMessageAction,
    FlagToChannelAction,
...
class MLSpamUpsertRequestTypedDict(TypedDict):
    name: str
    event_type: Literal[1]
    actions: NotRequired[Nullable[List[MLSpamUpsertRequestActionsTypedDict]]]
...
class MLSpamUpsertRequest(BaseModel):
    ...
    actions: OptionalNullable[List[MLSpamUpsertRequestActions]] = UNSET
