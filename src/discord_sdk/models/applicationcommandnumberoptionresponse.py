...
class ApplicationCommandNumberOptionResponseTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    choices: NotRequired[
        Nullable[List[ApplicationCommandOptionNumberChoiceResponseTypedDict]]
    ]
...
class ApplicationCommandNumberOptionResponse(BaseModel):
    ...
    choices: OptionalNullable[List[ApplicationCommandOptionNumberChoiceResponse]] = (
        UNSET
    )
