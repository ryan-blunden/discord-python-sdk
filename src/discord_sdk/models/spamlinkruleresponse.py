...
SpamLinkRuleResponseActionsTypedDict = Union[
    BlockMessageActionResponseTypedDict,
    FlagToChannelActionResponseTypedDict,
    QuarantineUserActionResponseTypedDict,
    UserCommunicationDisabledActionResponseTypedDict,
...
SpamLinkRuleResponseActions = Union[
    BlockMessageActionResponse,
    FlagToChannelActionResponse,
    QuarantineUserActionResponse,
    UserCommunicationDisabledActionResponse,
...
class SpamLinkRuleResponseTypedDict(TypedDict):
    id: str
    guild_id: str
    creator_id: str
    name: str
    actions: List[SpamLinkRuleResponseActionsTypedDict]
    trigger_metadata: SpamLinkTriggerMetadataResponseTypedDict
...
class SpamLinkRuleResponse(BaseModel):
    ...
    actions: List[SpamLinkRuleResponseActions]
