...
CreateMessageMultipartNonceTypedDict = Union[int, str]


CreateMessageMultipartNonce = Union[int, str]


class CreateMessageMultipartRequestBodyTypedDict(TypedDict):
    ...
    nonce: NotRequired[Nullable[CreateMessageMultipartNonceTypedDict]]
...
class CreateMessageMultipartRequestBody(BaseModel):
    ...
    nonce: Annotated[
        OptionalNullable[CreateMessageMultipartNonce], FieldMetadata(multipart=True)
    ] = UNSET

    enforce_nonce: Annotated[OptionalNullable[bool], FieldMetadata(multipart=True)] = (
        UNSET
    )

    tts: Annotated[OptionalNullable[bool], FieldMetadata(multipart=True)] = UNSET
...
class CreateMessageMultipartRequestTypedDict(TypedDict):
    channel_id: str
    request_body: CreateMessageMultipartRequestBodyTypedDict


class CreateMessageMultipartRequest(BaseModel):
