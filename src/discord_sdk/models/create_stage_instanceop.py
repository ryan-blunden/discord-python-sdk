...
class CreateStageInstanceRequestBodyTypedDict(TypedDict):
    topic: str
    channel_id: str
    privacy_level: Nullable[Literal[1]]
    guild_scheduled_event_id: NotRequired[Nullable[str]]
    send_start_notification: NotRequired[Nullable[bool]]


class CreateStageInstanceRequestBody(BaseModel):
    topic: str
    ...
    send_start_notification: OptionalNullable[bool] = UNSET
