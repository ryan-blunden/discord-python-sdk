...
class ApplicationCommandIntegerOptionTypedDict(TypedDict):
    name: str
    description: str
    type: Literal[1]
    ...
    choices: NotRequired[Nullable[List[ApplicationCommandOptionIntegerChoiceTypedDict]]]
...
class ApplicationCommandIntegerOption(BaseModel):
    ...
    choices: OptionalNullable[List[ApplicationCommandOptionIntegerChoice]] = UNSET
