...
class StringSelectTypedDict(TypedDict):
    custom_id: str
    options: List[SelectOptionTypedDict]
    type: Literal[1]
...
class StringSelect(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["placeholder", "min_values", "max_values", "disabled"]
        nullable_fields = ["placeholder", "min_values", "max_values", "disabled"]
        null_default_fields = []
