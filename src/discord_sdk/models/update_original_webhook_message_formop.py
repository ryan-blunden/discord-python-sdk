...
class UpdateOriginalWebhookMessageFormSecurityTypedDict(TypedDict):
    bot_token: NotRequired[str]


class UpdateOriginalWebhookMessageFormSecurity(BaseModel):
    bot_token: Annotated[
        Optional[str],
        FieldMetadata(
...
class UpdateOriginalWebhookMessageFormRequestTypedDict(TypedDict):
    webhook_id: str
    webhook_token: str
...
class UpdateOriginalWebhookMessageFormRequest(BaseModel):
