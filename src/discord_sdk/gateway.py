...
class Gateway(BaseSDK):
    def get(
        ...
        *,
        security: Optional[
            Union[models.GetGatewaySecurity, models.GetGatewaySecurityTypedDict]
        ] = None,
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.GetGatewaySecurity]
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GatewayResponse)
