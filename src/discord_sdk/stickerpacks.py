...
class StickerPacks(BaseSDK):
    def list(
        self,
        *,
        security: Optional[
            Union[
                models.ListStickerPacksSecurity,
                models.ListStickerPacksSecurityTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.StickerPackCollectionResponse:
        r"""
        :param security:
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.ListStickerPacksSecurity]
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_sticker_packs",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.StickerPackCollectionResponse
            )
    ...
    def get(
        ...
        *,
        ...
        request = models.GetStickerPackRequest(
            pack_id=pack_id,
        )
        ...
        data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.StickerPackResponse)
        if utils.match_response(http_res, "4XX", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ErrorResponseData)
            raise models.ErrorResponse(data=data)
        if utils.match_response(http_res, "5XX", "*"):
