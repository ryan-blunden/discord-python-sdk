...
class MessageReactions(BaseSDK):
    def delete_all_by_emoji(
        self,
        *,
        channel_id: str,
        message_id: str,
        ...
        request = models.DeleteAllMessageReactionsByEmojiRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_all_message_reactions_by_emoji",
                oauth2_scopes=[],
    ...
    async def delete_all_by_emoji_async(
        self,
        *,
        channel_id: str,
        message_id: str,
