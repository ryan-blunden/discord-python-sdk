...
class ChannelRecipients(BaseSDK):
    def add(
        self,
        *,
        channel_id: str,
        user_id: str,
        request_body: Union[
            models.AddGroupDmUserRequestBody, models.AddGroupDmUserRequestBodyTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> Optional[models.AddGroupDmUserResponseBody]:
        r"""
        :param channel_id:
        :param user_id:
        :param request_body:
        ...
        request = models.AddGroupDmUserRequest(
            channel_id=channel_id,
            user_id=user_id,
            request_body=utils.get_pydantic_model(
                request_body, models.AddGroupDmUserRequestBody
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.AddGroupDmUserRequestBody,
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="add_group_dm_user",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.AddGroupDmUserResponseBody
            )
