...
class ChannelThreadMembers(BaseSDK):
    def delete(
        self,
        *,
        channel_id: str,
        ...
        request = models.DeleteThreadMemberRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_thread_member",
                oauth2_scopes=[],
    ...
    def list(
        ...
        *,
        ...
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> List[models.ThreadMemberResponse]:
        r"""
        :param channel_id:
        :param with_member:
        :param limit:
        ...
        request = models.ListThreadMembersRequest(
            channel_id=channel_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_thread_members",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, List[models.ThreadMemberResponse]
            )
        if utils.match_response(http_res, "4XX", "application/json"):
            data = utils.unmarshal_json(http_res.text, models.ErrorResponseData)
            raise models.ErrorResponse(data=data)
