...
class ApplicationEntitlements(BaseSDK):
    def consume(
        self,
        *,
        security: Union[
            models.ConsumeEntitlementSecurity,
            models.ConsumeEntitlementSecurityTypedDict,
        ],
        application_id: str,
        entitlement_id: str,
        ...
        request = models.ConsumeEntitlementRequest(
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.ConsumeEntitlementSecurity
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="consume_entitlement",
