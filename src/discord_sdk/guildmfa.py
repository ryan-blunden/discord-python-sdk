...
class GuildMfa(BaseSDK):
    def set_level(
        self,
        *,
        guild_id: str,
        request_body: Union[
            models.SetGuildMfaLevelRequestBody,
            models.SetGuildMfaLevelRequestBodyTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.GuildMFALevelResponse:
        r"""
        :param guild_id:
        :param request_body:
        ...
        request = models.SetGuildMfaLevelRequest(
            guild_id=guild_id,
            request_body=utils.get_pydantic_model(
                request_body, models.SetGuildMfaLevelRequestBody
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="set_guild_mfa_level",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.GuildMFALevelResponse)
