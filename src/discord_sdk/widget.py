...
class Widget(BaseSDK):
    def get_png(
        ...
        *,
        ...
        security: Optional[
            Union[
                models.GetGuildWidgetPngSecurity,
                models.GetGuildWidgetPngSecurityTypedDict,
            ]
        ] = None,
        ...
        request = models.GetGuildWidgetPngRequest(
            guild_id=guild_id,
        )
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, Optional[models.GetGuildWidgetPngSecurity]
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="get_guild_widget_png",
                oauth2_scopes=[],
