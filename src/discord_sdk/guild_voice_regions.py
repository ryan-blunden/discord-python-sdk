...
class GuildVoiceRegions(BaseSDK):
    def list(
        self,
        *,
        guild_id: str,
    ...
    ) -> List[models.VoiceRegionResponse]:
        r"""
        :param guild_id:
        ...
        request = models.ListGuildVoiceRegionsRequest(
            guild_id=guild_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="list_guild_voice_regions",
                oauth2_scopes=[],
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, List[models.VoiceRegionResponse])
