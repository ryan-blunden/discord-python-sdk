...
class ChannelFollowers(BaseSDK):
    def follow(
        self,
        *,
        channel_id: str,
        request_body: Union[
            models.FollowChannelRequestBody, models.FollowChannelRequestBodyTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ) -> models.ChannelFollowerResponse:
        r"""
        :param channel_id:
        :param request_body:
        ...
        request = models.FollowChannelRequest(
            channel_id=channel_id,
            request_body=utils.get_pydantic_model(
                request_body, models.FollowChannelRequestBody
            ),
        )
        ...
        req = self.build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                False,
                "json",
                models.FollowChannelRequestBody,
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.ChannelFollowerResponse)
