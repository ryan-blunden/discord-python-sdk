...
class ChannelPermissions(BaseSDK):
    def delete_overwrite(
        ...
        *,
        ...
        request = models.DeleteChannelPermissionOverwriteRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_channel_permission_overwrite",
                oauth2_scopes=[],
    ...
    async def delete_overwrite_async(
        self,
        *,
        channel_id: str,
        overwrite_id: str,
