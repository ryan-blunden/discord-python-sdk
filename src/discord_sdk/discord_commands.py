...
class DiscordCommands(BaseSDK):
    def delete(
        self,
        *,
        security: Union[
            models.DeleteGuildApplicationCommandSecurity,
            models.DeleteGuildApplicationCommandSecurityTypedDict,
        ],
        application_id: str,
        guild_id: str,
        command_id: str,
        ...
        request = models.DeleteGuildApplicationCommandRequest(
        ...
        req = self.build_request(
            ...
            security=utils.get_pydantic_model(
                security, models.DeleteGuildApplicationCommandSecurity
            ),
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                operation_id="delete_guild_application_command",
